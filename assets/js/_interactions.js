...
THREE.TransformGizmoTranslateY = function () {
  ...
  this.pickerGizmos = {
    ...
    Y: [
      [ new THREE.Mesh( new THREE.CylinderBufferGeometry( 0.5, 0.5, 0.5, 4, 1, false ), pickerMaterial ), [ 0.5, 0.4, 0 ] ]
    ]
...
// THREE.TransformGizmoTranslateXZ = function () {
//
//   THREE.TransformGizmo.call( this );
//
//   var arrowGeometry = new THREE.Geometry();
...
// };
//
// THREE.TransformGizmoTranslateXZ.prototype = Object.create( THREE.TransformGizmo.prototype );
// THREE.TransformGizmoTranslateXZ.prototype.constructor = THREE.TransformGizmoTranslateXZ;
